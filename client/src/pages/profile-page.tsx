...
export default function ProfilePage() {
  ...
  console.log("ProfilePage component rendering. isEditProfileDialogOpen:", isEditProfileDialogOpen);
  // --- Manual Loading State for `onSave` if not using a mutation library ---
...
console.log("Profile ID from URL:", profileId);
    ...
    console.log("Profile object ID:", params?.id);
    console.log("Is Own Profile (calculated):", isOwnProfile);
  ...
  // Handler for Edit Profile Button (both buttons can use this)
    const handleEditProfileClick = useCallback(() => {
        setIsEditProfileDialogOpen(true);
        console.log("Edit Profile button clicked. isEditProfileDialogOpen:", true);
    }, []); // No dependencies as it just sets state to true
  ...
  return (
    <>
      ...
      <Footer />
      {/* --- IMPORTANT: Render your EditProfileDialog component here! --- */}
      <EditProfileDialog
        ...
        profile={{
          ...
          showroom1: profile.showroom1 ?? undefined,
          showroom2: profile.showroom2 ?? undefined,
          instagram: profile.instagram ?? undefined,
          facebook: profile.facebook ?? undefined,
          pinterest: profile.pinterest ?? undefined,
        ...
        // updateProfileMutation={updateProfileMutation} // Uncomment if using react-query
        // If not using react-query, pass your manual loading state:
        updateProfileMutation={{ isPending: isSavingProfile }}
      />
    </>
  );
}